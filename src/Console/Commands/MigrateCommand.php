...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'afzidan:migrate:subscriptions {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Migrate AFZidan Subscriptions Tables.';
